...
>
> **Last Generated**: 2026-08-12T03:14:42.646Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `config-file-changed` | Event | Restart application when configuration file changes | [`app/index.js:259`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L259) |
| `dock-icon-update` | Event | Update Dock icon with status overlay on macOS | [`app/index.js:282`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L282) |
| `get-app-version` | Request/Response | Get application version number | [`app/index.js:297`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L297) |
| `get-config` | Request/Response | Get current application configuration | [`app/index.js:261`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L261) |
| `get-navigation-state` | Request/Response | Get current navigation state (can go back/forward) | [`app/index.js:320`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L320) |
| `navigate-back` | Event | Navigate back in browser history | [`app/index.js:302`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L302) |
| `navigate-forward` | Event | Navigate forward in browser history | [`app/index.js:311`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L311) |
| `set-badge-count` | Request/Response | Set application badge count (dock/taskbar notification) | [`app/index.js:279`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L279) |
| `unhandled-rejection` | Event | Log renderer-side unhandled promise rejections | [`app/index.js:329`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L329) |
| `user-status-changed` | Request/Response | Handle user status changes from Teams (e.g., Available, Busy, Away) | [`app/index.js:277`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L277) |
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `play-notification-sound` | Request/Response | Play notification sound for Teams messages and calls | [`app/notifications/service.js:76`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/notifications/service.js#L76) |
| `show-notification` | Request/Response | Show system notification for Teams activity (legacy) | [`app/notifications/service.js:78`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/notifications/service.js#L78) |
| `show-notification-v2` | Request/Response | Show system notification with structured ParsedNotification (Phase 1) | [`app/notifications/service.js:80`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/notifications/service.js#L80) |
